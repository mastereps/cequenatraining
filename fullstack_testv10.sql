...
\restrict 6ojK8cIc33gqdJRHCkv3E9IWiankTEXFs4Bh0tZuwyCMRpGZb0gOjFqEojYrJS4
...
8c88187b-42dd-49f0-a82c-32040ad606be	efraim.gondraneos@gmail.com	webinar.verify	{"full_name": "Efraim Gondraneos", "queued_at": "2026-02-04T04:11:58.449Z", "verify_url": "http://localhost:5173/verify?token=DRfotIVN9_q5wiYrUy5hEWQhSGpOvCctrCxNd51zvMo", "webinar_slug": "flipped-model-in-an-online-platform", "webinar_title": "Flipped Model in an Online Platform", "token_expires_at": "2026-02-05T04:11:58.475Z", "webinar_start_at": "2026-03-22T00:00:00.000Z", "webinar_timezone": "Asia/Manila"}	sent	1	\N	2026-02-04 12:11:58.422012+08	2026-02-04 12:12:04.705527+08	2026-02-04 12:12:04.705527+08
2c8eeb74-ab73-4607-af49-2e3626a42d37	efraim.gondraneos@gmail.com	webinar.confirmed	{"join_url": "https://zoom.us/j/9100100200?pwd=flipped", "full_name": "Efraim Gondraneos", "webinar_slug": "flipped-model-in-an-online-platform", "webinar_title": "Flipped Model in an Online Platform", "webinar_start_at": "2026-03-22T00:00:00.000Z", "webinar_timezone": "Asia/Manila"}	sent	1	\N	2026-02-04 12:12:37.916464+08	2026-02-04 12:12:44.726122+08	2026-02-04 12:12:44.726122+08
\.
...
4	Efraim Gondraneos	goliathdavid024@gmail.com	scrypt$b6522d7eb7c317f99fa3b3779a1b574f$a2363e49f933fb7c899d92a32d41f38f4b8e31eb0c334df1489f6f8a4482b9fcbb8d4fb9c9389a6e9b47af0621def288c2ac0c29795f12d18af7e7407d9657fb	customer	2026-02-04 12:46:15.218769+08
5	Efraim Gondraneos	efraim.gondraneos@gmail.com	scrypt$324778dc8b5bcdecc4f7bb1080de5ec4$c83daaaeb7acc089eef332512b0bde5c997f7fb72dbdcd5c34359aa333f80629bdd5e3dfba7c9827416d8f2d1d83052f3922f9f079aaf28125928f4d5ea1d9a9	customer	2026-02-04 15:18:42.826686+08
\.
...
f92710dd-1fb1-47b4-86de-92e68a726274	register	934406b0-fee8-4112-8b95-b282d09cea48	efraim.gondraneos@gmail.com	2026-02-04 12:00:00+08	1	2026-02-04 12:11:58.422012+08	2026-02-04 12:11:58.422012+08
\.
...
COPY public.webinar_registrations (id, webinar_id, email, full_name, status, verify_token_hash, verify_token_expires_at, verified_at, zoom_registrant_join_url, optional_fields_json, last_verification_email_sent_at, last_confirmation_email_sent_at, created_at, updated_at, user_id) FROM stdin;
971439b2-459c-4738-ba10-d638a878c7a6	934406b0-fee8-4112-8b95-b282d09cea48	efraim.gondraneos@gmail.com	Efraim Gondraneos	verified	d038b8312e56c4f5e0131f1dbecf5e45c58a91f96c8232bab2285b36eaa44b93	2026-02-05 12:11:58.475+08	2026-02-04 12:12:37.916464+08	\N	{"role": "", "organization": ""}	2026-02-04 12:11:58.422012+08	2026-02-04 12:12:37.916464+08	2026-02-04 12:11:58.422012+08	2026-02-04 12:12:37.916464+08	\N
\.
...
--
-- Name: carts_one_active_per_user; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX carts_one_active_per_user ON public.carts USING btree (user_id) WHERE ((user_id IS NOT NULL) AND (status = 'active'::text));
...
--
-- Name: webinar_registrations_unique_user_per_webinar; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX webinar_registrations_unique_user_per_webinar ON public.webinar_registrations USING btree (webinar_id, user_id) WHERE (user_id IS NOT NULL);
...
--
-- Name: webinar_registrations webinar_registrations_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.webinar_registrations
    ADD CONSTRAINT webinar_registrations_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE SET NULL;
...
\unrestrict 6ojK8cIc33gqdJRHCkv3E9IWiankTEXFs4Bh0tZuwyCMRpGZb0gOjFqEojYrJS4
