---
name: refactoring
description: Behavior-preserving restructuring in small reversible steps. Use when cleaning up or reshaping existing code without changing what it does - especially server/server.js, where legacy inline routes and layered routes/controllers/services coexist. Covers code smells, safe transformations, and keeping structural edits separate from behavior changes.
---
...
Source: [ciembor/agent-rules-books](https://github.com/ciembor/agent-rules-books) (Refactoring by Martin Fowler), MIT licensed. Verbatim `mini` edition.
