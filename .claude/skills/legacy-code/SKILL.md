---
name: legacy-code
description: Safely changing code that has weak or missing tests, unclear behavior, or hidden dependencies. Use before editing untested areas such as webinar/server, the inline books/cart/contact routes, or anything lacking characterization tests. Covers seams, dependency breaking, and gaining control before improving design.
---
...
Source: [ciembor/agent-rules-books](https://github.com/ciembor/agent-rules-books) (Working Effectively with Legacy Code by Michael Feathers), MIT licensed. Verbatim `mini` edition.
