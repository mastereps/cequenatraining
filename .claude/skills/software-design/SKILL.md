...
description: Reducing complexity through deep modules and information hiding. Use when adding a module, layer, helper, wrapper, option, or API boundary, or when a change feels awkward and spreads across files. Covers interface design, decomposition, naming, and when an abstraction earns its existence.
---
...
Source: [ciembor/agent-rules-books](https://github.com/ciembor/agent-rules-books) (A Philosophy of Software Design by John Ousterhout), MIT licensed. Verbatim `mini` edition.
